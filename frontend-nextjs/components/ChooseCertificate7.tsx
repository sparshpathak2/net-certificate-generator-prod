...
export default function ChooseCertificate() {
  ...
  return (
    // <div className="flex flex-col w-full max-w-3xl mx-auto border rounded-xl p-3 sm:p-4 gap-4" style={{ height: 'calc(100vh - 86px)' }}>
    <div
    ...
    >
      ...
      {hasFiles ? (
        <div className="flex-1 flex flex-col gap-3 min-h-0">
          ...
          {/* Scrollable list container - THIS IS THE ONLY PART THAT SCROLLS */}
          {/* <div className="flex-1 overflow-y-auto min-h-0 pr-1 custom-scrollbar border-t px-4"> */}
